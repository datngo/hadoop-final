...
public class TestProcessMedicare {
    ...
    public void testReducer() {
        ...
        values.add(new Text("50226#7646.363636"));
    ...
    public void testMapReduce() {
        ...
        mapReduceDriver.addOutput(new Text("50226"), new DoubleWritable(49567.6875));//1679.909091
//        mapReduceDriver.addOutput(new Text("10026"), new DoubleWritable(1679.9090910000004));
    ...
    private Text createDataReducerValue(){
        return new Text("50226#49567.6875");
    }
