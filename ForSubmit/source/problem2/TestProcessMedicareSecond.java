...
public class TestProcessMedicareSecond {
    ...
    public void testReducer() {
        ...
        reduceDriver.withOutput(new Text(reducerOutputKey.toString()),
                new IntWritable(reducerOutputvalue));
    ...
    public void testMapReduce() {
        ...
        mapReduceDriver.addOutput(new Text("1234"),
                new IntWritable(Integer.parseInt("2")));
